...
hidden if the `one_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `one_DEVELOPER_MODE` to the configure
...
Runs the executable target `one_exe`.
